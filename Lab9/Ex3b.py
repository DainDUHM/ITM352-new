...
if fare_count > 0:
    ...
    print(f"Total of all fares greater than $10: ${fare_total:.2f}")
    print(f"Average fare (greater than $10): ${average_fare:.2f}")
    print(f"Maximum trip distance for fares greater than $10: {max_trip_distance:.2f} miles")
else:
    print("No fare data greater than $10 found.")