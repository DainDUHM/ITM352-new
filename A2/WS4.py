...
#import the data file. This needs to be downloaded to be used my Pandas
#It is in CSV format 
...
def load_csv(file_path):
    ...
    try: 
        print("Reading CSV file: {local_path}")
        ...
        print("Error: the file {file_path} had a problem parsing.")    
    except Exception as e:
        print(f"An unexpected error has occurred: {e}")

#Fnction to display user # of rows
...
#Display the top-level menu of user option 
...
def employees_by_region(data):
    ...
    pivot_table.columns = ['Number of Employees'] #Rename the column for readibility
    print(pivot_table)
    return pivot_table
...
#IF this is the main program, call()
